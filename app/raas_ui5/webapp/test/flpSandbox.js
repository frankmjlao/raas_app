			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RAAS_APP_V1-display": {
								"semanticObject": "RAAS_APP_V1",
								"action": "display",
								"description": "Robotic as a service application v1.0",
								"title": "RAAS_APP_V1",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=raasui5",
									"url": sap.ui.require.toUrl("raasui5")
								}
							}
						}
					}
